...
## 1. Introduction
   ...
   Section 11.5 of [RFC6455](https://www.rfc-editor.org/rfc/rfc6455.html) sets up a WebSocket Subprotocol Name
   Registry at IANA and directs IANA to use First Come First Serve
   registration procedures as set out in [RFC5226](https://www.rfc-editor.org/rfc/rfc5226.html).  The reuse of this
