...
/**
 * Manages encoders and decoders for a WebSocket client endpoint.
 * This class handles instantiation and lifecycle of encoder/decoder instances.
 */
public class ClientEndpointCodecs {
    ...
    /**
     * Creates encoder and decoder instances from the endpoint's @ClientEndpoint annotation.
     * 
     ...
     */
    public ClientEndpointCodecs(Class<?> endpointClass, ClientEndpointConfig config) throws InstantiationException {
